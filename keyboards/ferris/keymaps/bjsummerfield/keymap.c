...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME_NO_REMAP] = LAYOUT(
        _______, KC_E,    KC_W,    _______, _______,       _______, _______, _______, _______, _______,
        KC_F,    KC_A,    KC_S,    KC_D,    _______,       _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______,
                                          _______, KC_SPC, _______, _______
    ),
    [_TRADING] = LAYOUT(
        KC_F, KC_D,    _______,    _______, _______,       _______, _______, _______, _______, _______,
        KC_A,    KC_Q,    KC_S,    KC_W,    _______,       _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______,
                                          _______, KC_SPC, _______, _______
    ),
    [_DOTA] = LAYOUT(
    ...
    [_FUNCTION] = LAYOUT(
        ...
        _______, _______, _______, DF(_QWERTY), DF(_GAME), DF(_GAME_NO_REMAP), DF(_TRADING), _______, _______, _______,
                                          _______, _______, _______, _______
    )
};
